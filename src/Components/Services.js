            ...
            <div className="mt-16 container">
                ...
                <div className="row mt-8 mr-auto ml-auto md:text-center sm:text-center">
                    <div className="col-lg-4 mb-8">
                        ...
                        <p className="text-xl">We produce wide variety of products<br/>
                    ...
                    <div className="col-lg-4 mb-8">
                        ...
                        <p className="text-xl">Quality dairy products such as<br/> yogurt, cheese and butter from<br/>
                    ...
                    <div className="col-lg-4 mb-8">
                        ...
                        <p className="text-xl">Organic fertilizers which are <br/>
                ...
                <div className="mt-8 text-white" id="wrapper" >
                    <h1 className="text-center pt-10">Services we offer</h1>
                        ...
                        <div className="flex container justify-around mt-8">
                            ...
                            <div className="">
                                <h1 id="serviceHeader" className="font-bold text-3xl">Healthy Milk</h1>

                                <p className="text-xl">We provide milk through our diary products</p>
                            </div>
                            <div className="">
                                <h1 id="serviceHeader" className="font-bold text-3xl">Fumigation</h1>

                                <p className="text-xl">Farm Ng gives a high quality fumigation service</p>
                            </div>
                            <div className="">
